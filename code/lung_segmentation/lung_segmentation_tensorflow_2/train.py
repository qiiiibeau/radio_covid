...
DIR_DATA = '../../../data/COVID-19_Radiography_Dataset/COVID'
...
def read_mask(path1, path2=None):
...
if __name__ == "__main__":
    ...
    (train_x, train_y1), (valid_x, valid_y1), (test_x, test_y1) = load_data(DIR_DATA)
