...
from tabs import intro, dataset, data_exploration, preprocessing, model_winner, u_net, test_tab
...
TABS = OrderedDict(
    [
        ...
        (model_winner.sidebar_name, model_winner),
        (u_net.sidebar_name, u_net),
        (test_tab.sidebar_name, test_tab)
    ]
)
